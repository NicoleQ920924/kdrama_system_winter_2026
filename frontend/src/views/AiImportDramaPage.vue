<script setup>
    ...
    const promptToSend = computed(() => {
        ...
        lines.push('請再三透過搜尋確認劇名都是台灣官方譯名，且簡介有包含劇情大綱。')
        lines.push('請用繁體中文回覆，並以 JSON 格式提供劇名和簡介。')
        return lines.join('\n')
    })

    async function startAiImportDrama() {
            ...
            <div v-else key="form">
                <form class="form" method="post">
                    ...
                    <p class="form-group form-text-p">
                        ...
                        <input v-model="actorName2" id="actorName2" class="form-control form-text-field" name="actorName2" placeholder="例如：IU">
                    </p>
                    <p class="form-group form-text-p">
                        <label for="actorName3" class="form-label">演員姓名 3</label>
                        <input v-model="actorName3" id="actorName3" class="form-control form-text-field" name="actorName3" placeholder="例如：孔劉">
                    </p>

                    <p class="form-group form-text-p">
                        <label for="characterName1" class="form-label">角色名稱 1</label>
                        <input v-model="characterName1" id="characterName1" class="form-control form-text-field" name="characterName1" placeholder="例如：崔澤">
                    </p>
                    <p class="form-group form-text-p">
                        <label for="characterName2" class="form-label">角色名稱 2</label>
                        <input v-model="characterName2" id="characterName2" class="form-control form-text-field" name="characterName2" placeholder="例如：成德善">
                    </p>
                    <p class="form-group form-text-p">
                        <label for="characterName3" class="form-label">角色名稱 3</label>
                        <input v-model="characterName3" id="characterName3" class="form-control form-text-field" name="characterName3" placeholder="例如：金尚宮">
                    </p>
                    ...
                    <p class="form-group form-text-p">
                        ...
                        <textarea
                            ...
                            rows="3"
                            placeholder="例如：女主角是冷靜理性、外冷內熱的律師..."
                        />
                    </p>
                    ...
                    <p class="form-group form-text-p">
                        ...
                        <textarea
                            ...
                            name="partOfPlot"
                            rows="4"
                            placeholder="例如：男女主角在雨中相遇，之後一起查案/復仇/救援..."
                        />
                    </p>

                    <p class="form-group form-text-p">
                        <label for="genre1" class="form-label">類型 1</label>
                        <input v-model="genre1" id="genre1" class="form-control form-text-field" name="genre1" placeholder="例如：浪漫 / 懸疑 / 驚悚 / 喜劇 / 古裝">
                    </p>
                    <p class="form-group form-text-p">
